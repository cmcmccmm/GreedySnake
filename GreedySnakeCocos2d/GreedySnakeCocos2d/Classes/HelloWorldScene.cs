...
namespace GreedySnakeCocos2d
{
    public class GreedySnakeCocos2dScene : CCLayer
    {
        /// <summary>
        ...
        public static CCScene scene()
        {
            ...
            CCLayer layer = GreedySnakeCocos2dScene.node();
        ...
        {
            GreedySnakeCocos2dScene ret = new GreedySnakeCocos2dScene();
            if (ret.init())
            {
                return ret;
            }
